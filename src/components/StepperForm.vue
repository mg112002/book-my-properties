...
export default {
  ...
  data() {
    return {
      loading:false,
      stripe: null,
      priceId: 'price_1MnRSdSHsghl0djFfNmjQxsX',
      // lineItems: [
      //   {
  ...
  methods: {
    ...
    async redirectToCheckout() {
      ...
      if (!this.stripe) {
        this.stripe = await loadStripe('sk_test_51Mn5efSHsghl0djFCtTT8xDTvf5VZ3OAIezMy7Qo3pwEIcuCIAudUjo7UB9EkdWmEdyfW4Hm8iVLC1u1qz5pIwCT00GdDr6hkY'); // replace with your own public key
      }
